...
hashpipe_databuf_t *FAST_input_databuf_create(int instance_id, int databuf_id)
{
    ...
    size_t header_size = sizeof(hashpipe_databuf_t)
                       + sizeof(FAST_input_header_cache_alignment);
    size_t block_size  = sizeof(FAST_input_block_t);
...
hashpipe_databuf_t *FAST_output_databuf_create(int instance_id, int databuf_id)
{
    /* Calc databuf sizes */
    size_t header_size = sizeof(hashpipe_databuf_t)
                       + sizeof(FAST_output_header_cache_alignment);
    size_t block_size  = sizeof(FAST_output_block_t);
